    ...
    return (
        <ul className="period-info">
            {//신청 전(오늘, 기간남음, 정원 초과)
                ...
                <li className="row">
                    <div className="p-head"><Icon className='icon-pencil'/><strong>신청</strong></div>
            ...
            {//신청후(승인 대기, 학습 예정) ~ 학습 전
                ...
                <li className="row">
                    <div className="p-head"><Icon className='icon-cancle'/><strong>취소</strong></div>
                    <div className="p-detail"><span>10.18 ~ 12.31</span></div>
                </li>
            }
            {//학습 중, 학습 완료
            ...
            {//교육 종료
                (status === "studyEnd") &&
                <li className="row">
                    <div className="p-head"><Icon className='icon-book-open'/><strong>교육</strong></div>
...
function ActionsStatus (props) { // 상태별 하단 버튼 또는 상태표시
    ...
    switch(status) {
        ...
        case "applyEnd" :
            return <Button className="confirm" disabled><strong>신청 하기</strong></Button>
        case "studyEnd" :
            return <Button className="confirm" disabled><strong>신청 하기</strong></Button>
