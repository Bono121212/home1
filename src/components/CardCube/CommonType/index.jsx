...
const CardCommonType = (props) => {
    ...
    return (
        <div data-action='CLICK' data-action-name=''>{/* 2023-11-17 개발 페이지와 구조 통일화를 위해 추가 */}
            <Card className={classNames('card-item', {'on':isHovered})} onMouseEnter={() => setIsHovered(true)} onMouseLeave={() => setIsHovered(false)}>
