...
export default class UserHeader extends Component {
    ...
    state = {activeItem: '', noticeOpen: false, isGfield :false , isAuto : false, isOpen : false, isMain : true, isFixed :false, write: '',isChecked : false, isSearch : true, isValue: false};
    ...
    render() {
        const {activeItem, noticeOpen, isGfield, isOpen, isFixed, isAuto, isChecked, isSearch} = this.state;
        ...
        return (
            <div className={classNames({'margin-bottom-80':isFixed})}>
                ...
                <section className={classNames("header main-sty2 lms-main career career-search",{" fixed" : isFixed})} ref={this.gfieldRef}>
                    ...
                    <div className={classNames("group",{'off' : isGfield})}>
                        <div className="cont-inner">
                            ...
                            <div className="g-search-header" onClick={this.searchClick}>
                                <div className={classNames("search_wrap",{'show_re' : isChecked})}>
                                    ...
                                    <input 
                                        ...
                                        placeholder={ isChecked ? "검색어를 입력해주세요." : "무엇을 배우고 싶으신가요?" } 
                                        onChange={this.handleChange}
                                        value={this.isValue !== false && '# 데이터'} //퍼블확인용 isValue
                                    />
                                </div>
                            ...
                            <Checkbox
                                ...
                                label="결과 내 재검색"
                                checked={isChecked} //결과내 재검색 상황인 경우에는 true
