            ...
            <div className="w_wrap">
                ...
                <div className={classNames("w_inner_auto",{"on" : auto})}>
                    <ul className="auto_list">
                        <li className="auto_item"><a href="#none"><strong className="a_text">데이터</strong></a></li>
                        <li className="auto_item"><a href="#none"><strong className="a_text">데이터</strong> 관련주</a></li>
                        <li className="auto_item"><a href="#none"><strong className="a_text">데이터</strong> 전망</a></li>
                        <li className="auto_item"><a href="#none"><strong className="a_text">데이터</strong> 공정 절차</a></li>
                        <li className="auto_item"><a href="#none"><strong className="a_text">데이터</strong> etf</a></li>
                        <li className="auto_item"><a href="#none"><strong className="a_text">데이터</strong> 대란에 대한 어드밴스</a></li>
                        <li className="auto_item"><a href="#none"><strong className="a_text">데이터</strong> 부족 이유</a></li>
                        <li className="auto_item"><a href="#none"><strong className="a_text">데이터</strong> 공급망 보고서</a></li>
                        <li className="auto_item"><a href="#none">한미 <strong className="a_text">데이터</strong>, 배터리 연계 기회</a></li>
                        <li className="auto_item"><a href="#none"><strong className="a_text">데이터</strong> 설비용 소재 및 산업용 스테인레스 매출 관계</a></li>
                    </ul>
                </div>
            </div>
        )
