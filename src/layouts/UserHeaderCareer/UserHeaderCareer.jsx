...
import AlimNoImage from '../../images/all/icon-alram-50-px.png'
    ...
    render() {
        ...
        return (
            <div className={classNames({ "margin-bottom-80": isFixed })}>
                ...
                <section className={classNames("header main-sty2 lms-main career ", { "fixed": isFixed })} ref={this.gfieldRef}>
                        ...
                        <div className="cont-inner">
                            ...
                            <div className="g-info-new">
                                <div className="g-learn">
                                    <Link to="#" className="go-learn">My Learning</Link>
                                </div>
                                <div ref={this.alarmRef}>
                                    <Link to="#" className="lms-alarm lms-on" onClick={this.handleClick}><span>알람</span></Link>
                                    ...
                                    <div className={classNames("lms-alarm-list", { 'lms-on': isOpen })}>
                                        ...
                                        {/* 알람없음 */}
                                        <div className='lms-alarm-nodata'>
                                            <img src={AlimNoImage} alt="" />
                                            <p className='tit'><strong>새로운 알림이 없습니다.</strong></p>
                                            <p className='txt'>나의 학습, 커뮤니티 활동 소식을<br />한 번에 받아보세요.</p>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div className="breadcrumbs">
                        <div className="cont-inner">
                            <div className="ui standard breadcrumb">
                                ...
                                <Link to="#" className="section">depth1</Link>
                                <i className="right chevron icon divider" />
