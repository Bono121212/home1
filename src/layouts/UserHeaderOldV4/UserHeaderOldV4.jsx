...
export default class UserHeaderV4 extends Component {
    ...
    render() {
        ...
        return (
            <>
                ...
                <section className="header lms g-ab g-tmp">{/*lms 추가  신규 컨텐트 일경우*/}
                    <div className="group">
                        <div className="cont-inner">
                            ...
                            <div className="g-search g-ab"> {/* 추후 글로벌 추가시 class 추가 g-ab*/}
                            ...
                            <div className="g-info g-info2 g-ab2">
                                ...
                                {/* 영어,중국어 선택시 알림 아이콘없음 section에 g-tmp 클래스 추가*/}
