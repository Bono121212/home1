                    ...
                    <List>
                        <List.Item>
                            <div className="title">
                                <h3 className="title-style">
                                    <Label className='onlytext bold size24'>
                                        <Icon className='period'/><span>{/* Registration period */}수강신청기간</span>
                                    </Label>
                                </h3>
                            </div>
                        ...
                        <List.Item>
                            <div className="title">
                                <h3 className="title-style">
                                    <Label className='onlytext bold size24'>
                                        <Icon className='cancellation'/><span>{/* Cancellation period */}취소가능기간</span>
                                    </Label>
                                </h3>
                            </div>
                            <div className="detail">
                                2020.01.15 ~ 2020.01.25
                                <div className="info">No Show Penalty
 : 20% of the lecture fee and no application
                                    for training for three months </div>
                            </div>
                        </List.Item>
                    </List>
                </div>
