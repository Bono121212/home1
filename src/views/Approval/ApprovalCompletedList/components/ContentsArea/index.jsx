                    ...
                    <div className='confirm-list-wrap'>
                        ...
                        <div className='confirm-list'>
                            <div className="row thead">
                                ...
                                <span className="cell date">승인일자</span>
                            ...
                            <div className="row">
                                ...
                                <span className="cell team"><span className="ellipsis">일이삼사오육칠팔구십일이삼사오육칠팔구십</span></span>
                                <span className="cell title">
                                    <Link href="#" target="_blank" className="ellipsis">
