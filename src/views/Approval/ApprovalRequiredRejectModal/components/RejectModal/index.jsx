            ...
            <Modal open={open} onClose={this.close} className='base w700'>
                ...
                <Form className='base'>
                        ...
                        <div className="scrolling-80vh">
                            <div className="content-wrap6">
                                <div className="my-03-01-pop">
                                    <div className="text1">선택된 항목에 대한 결제를 반려하시겠습니까?</div>
                                    <div className="text2">작성하신 의견은 결제가 반려되는 신청자에게 동일하게 전송됩니다.</div>
                    ...
                    <Modal.Actions className="actions2">
                        ...
                        <Button className='pop2 p' onClick={this.close}>반려</Button>
                    </Modal.Actions>
                </Form>
            </Modal>
        )
