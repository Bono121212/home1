...
class ContentsAreaError extends Component{
                    ...
                    <div className="form-section">
                        <Form>
                            <Form.Field>
                                ...
                                <div className={classNames("ui h48 input error", { focus: this.state.focus1, write: this.state.write1 })}>
                                    <input
                                        type="text"
                                        id='input1'
                                        placeholder="현재 비밀번호"
                            ...
                            <Form.Field>
                                <label>새 비밀번호</label>
                                <div className={classNames("ui h48 input error", { focus: this.state.focus2, write: this.state.write2 })}>
                                    <input
                                        type="text"
                                        placeholder="새 비밀번호"
                            ...
                            <Form.Field>
                                <div className={classNames("ui h48 input error", { focus: this.state.focus3, write: this.state.write3 })}>
                                    <input
                                        type="text"
                                        id='input1'
...
export default ContentsAreaError;
