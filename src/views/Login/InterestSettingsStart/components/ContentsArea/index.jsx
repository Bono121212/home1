...
import introheaderbg from "../../../../../images/all/b-copy-v2.png";
                    ...
                    <div className="intro-header">
                        <div className="inner interest">
                            ...
                            <div className="text-wrap">
                                <h2>맞춤형 학습 설정 시작하기</h2>
                                <p>몇 가지 질문을 통해 OOOOO님에게 맞는 학습 과정을 추천해 드릴게요!</p>
                                <Link to={'/login/interest-settings-part'}>
                                    <Button className="ui button fix bg">시작하기</Button>
                                </Link>
                            </div>
                        </div>
                    </div>
