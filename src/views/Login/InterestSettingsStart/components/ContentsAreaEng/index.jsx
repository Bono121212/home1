...
import introheaderbg from "../../../../../images/all/onboarding-eng.png";

class ContentsAreaEng extends Component {
    state = {}
                ...
                <div className="setting-introduction">
                    <div className="intro-header">
                        <div className="inner interest">
                            <Image src={introheaderbg} className="intro-header-img" alt="맞춤형 학습설정 시작하기" />
                            <div className="text-wrap">
                                <h2>Get started setting up<br />your customized learning</h2>
                                <p>We’ll ask you a few questions and recommend courses perfect for you, OOOOO!</p>
...
export default ContentsAreaEng
