                    ...
                    <Table>
                        ...
                        <TableBody>
                            ...
                            <Table.Row>
                                ...
                                <Table.Cell>
                                    <strong>SK이노베이션</strong>
                                </Table.Cell>
                            </Table.Row>
                            <Table.Row>
                                <Table.HeaderCell>부서명<span id="type">*</span></Table.HeaderCell>
                                <Table.Cell>
                                    <Input type="text" placeholder="입력해주세요."/>
                                </Table.Cell>
                            </Table.Row>
                            <Table.Row>
                                <Table.HeaderCell>직위/직책<span id="type">*</span></Table.HeaderCell>
                                <Table.Cell>
                                    <Input type="text" placeholder="입력해주세요."/>
                                </Table.Cell>
                            </Table.Row>
                            <Table.Row>
                                <Table.HeaderCell>사번<span id="type">*</span></Table.HeaderCell>
                                <Table.Cell>
                                    <Input type="text" placeholder="입력해주세요."/>
                                </Table.Cell>
                            </Table.Row>
