...
class FoundationSkillApplyPageComp extends Component {
    render(){
        return(
                        ...
                        <div className='skill-cont'>
                            <ul className='form-items'>
                                <li className='item'>
                                    <div className='ui checkbox check-skill'>
                                        <input class="hidden" name="skillCheck" id="skillCheck1" readonly="" tabindex="0" type="checkbox" value="혁신가의 창의적 문제해결 Skill"  checked disabled/>
                                ...
                                <li className='item'>
                                    <div className='ui checkbox check-skill'>
                                        <input class="hidden" name="skillCheck" id="skillCheck2" readonly="" tabindex="0" type="checkbox" value="컨설턴트의 논리적 문제해결 Skill" disabled />
                                ...
                                <li className='item'>
                                    <div className='ui checkbox check-skill'>
                                        <input class="hidden" name="skillCheck" id="skillCheck3" readonly="" tabindex="0" type="checkbox" value="도전! 가치창출을 위한 새로운 비즈니스 모델 만들기" disabled />
                                ...
                                <li className='item'>
                                    <div className='ui checkbox check-skill'>
                                        <input class="hidden" name="skillCheck" id="skillCheck4" readonly="" tabindex="0" type="checkbox" value="디지털 리터러시 : Digital 시대를 살아가기 위한 기초 체력" checked disabled />
                            ...
                            <div className='form-items-write'>
                                ...
                                <div className='item-input'>
                                    <textarea name="skillTextarea" id="skillTextarea2" placeholder="" cols="30" rows="3" disabled></textarea>
                                </div>
                            </div>

                            <div className='form-action'>
                                <Button className='btn-submit' disabled>신청완료</Button>
                            </div>
                        </div>
                    </div>
                </div>
...
export default FoundationSkillApplyPageComp