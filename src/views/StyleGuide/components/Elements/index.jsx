...
import {Button, Rating, Icon, Label} from 'semantic-ui-react'
                ...
                <div className="gCont">
                    ...
                    <section>
                        ...
                        <p className="gInfo">/js/semantic.min.js <a
                            ...
                            target="_blank" rel="noopener noreferrer" className="link">(Semantic UI - 2.4.1)</a></p>
                        <p className="gInfo">/js/state.min.js <a
                            href="https://semantic-ui.com/introduction/getting-started.html"
                            target="_blank" rel="noopener noreferrer" className="link">(Semantic UI - 2.4.1)</a></p>
                        <p className="gInfo">/js/calendar.min.js <a href="https://fomantic-ui.com/" target="_blank" rel="noopener noreferrer"
                                                                    className="link">(Fomantic
                            UI - 2.7.8)</a></p>
                        <p className="gInfo">/js/modal.min.js <a href="https://fomantic-ui.com/" target="_blank" rel="noopener noreferrer"
                                                                 className="link">(Fomantic
                            UI - 2.7.8) </a><a href="https://github.com/Semantic-Org/Semantic-UI/issues/6449"
                                               target="_blank" rel="noopener noreferrer">Semantic
                            UI - 2.4.1 팝업내에 스크롤 문제</a></p>
                        <p className="gInfo">/js/jquery-1.12.4.js <a href="https://jquery.com/" target="_blank" rel="noopener noreferrer"
                                                                     className="link">(Jquery -
                            1.12.4)</a></p>
                        <h2 className="test">CSS Version (해당 파일은 수정 금지)</h2>
                        <p className="gInfo">/css/semantic.min.css <a
                            href="https://semantic-ui.com/introduction/getting-started.html"
                            target="_blank" rel="noopener noreferrer" className="link">(Semantic UI - 2.4.0)</a></p>
                        <p className="gInfo">/css/calendar.min.css <a href="https://fomantic-ui.com/" target="_blank" rel="noopener noreferrer"
                                                                      className="link">(Fomantic
                            UI - 2.7.8)</a></p>
                    </section>
                    {/*Version*/}
                    ...
                    <section>
                        ...
                        <div className="preview" style={{"overflow":"visible"}}>
                            <button className="ui icon img-icon custom button"><i aria-hidden="true" className="noti32 icon"></i><span className="blind">취소 패널티</span></button>
                    ...
                    <section>
                        ...
                        <div className="preview">
                            <i aria-hidden="true" className="learning32 icon"/>
                            <i aria-hidden="true" className="community32 icon"/>
                            <i aria-hidden="true" className="support32 icon"/>
                        </div>
