            ...
            <>
                ...
                <Accordion className='channel'>
                    ...
                    <Accordion.Title
                        ...
                        onClick={this.handleClick}
                    >
                        <span className="name marine">Management</span>
                        <Icon/>
                    </Accordion.Title>
                    ...
                    {/* <Accordion.Title
                        ...
                        onClick={this.handleClick}
                    >
                        <span className="name teal">미래반도체</span>
                        <Icon />                        
                    </Accordion.Title>
                    ...
                    <Accordion.Title
                        ...
                        onClick={this.handleClick}
                    >
                        <span className="name bluegreen">Environment</span>
                        <Icon />                        
                    </Accordion.Title>
                    ...
                    <Accordion.Title
                        ...
                        onClick={this.handleClick}
                    >
                        <span className="name orange">SK아카데미</span>
                        <Icon />                        
                    </Accordion.Title>
