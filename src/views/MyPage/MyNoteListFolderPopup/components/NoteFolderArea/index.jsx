                    ...
                    <div className="folder_inner">
                        ...
                        <div className="folder_box">
                            <ul>
                                ...
                                <li>
                                    <Button className="folder">공부왕 김천재1</Button>
                                    <Button className="setting"><Icon /></Button>
                                    <Button className="left"><Icon /></Button>
                                    <Button className="right"><Icon /></Button>
                                </li>
                                <li>
                                    <Button className="folder">공부왕 김천재2</Button>
                                    <Button className="setting"><Icon /></Button>
                                    <Button className="left"><Icon /></Button>
                                    <Button className="right"><Icon /></Button> 
                                </li>
                                <li><Button className="folder">직박구리1</Button></li>
                                <li><Button className="folder">직박구리2</Button></li>
                                <li><Button className="folder">직박구리3</Button></li>
