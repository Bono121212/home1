...
import CardThumbImg from '../../../../../images/all/bg-topiccard4.png';

class HotTopicCard04 extends Component {
    render() {
        return (
            <Card className="topic-item" href="#none">
                ...
                <div className="card-inner">
                    ...
                    <div className="topic-tit"><span>알아두면 쓸모있는 글로벌 경제 잡학사전</span></div>
                    <div className="topic-info-wrap">
                        ...
                        <Label className="topic-info time">
                            <Icon className="card-time-wht"/><span>48h 30m</span>
                        </Label>
                    </div>
                </div>
            </Card>
