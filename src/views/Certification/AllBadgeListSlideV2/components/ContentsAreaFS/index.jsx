...
//FoundationSkill Open Version

export default class ContentsAreaFS extends Component {
    ...
    render() {
        ...
        const { activeItem, val, isChecked } = this.state;
        ...
        return (
            <div ref={this.contextRef}>
                ...
                <Segment className='full badge-list-page'>
                    ...
                    {/* FoundationSkill인경우 보여주는 설명 */}
                    {val === 'FoundationSkill' &&
                    <div className='cate-info-area'>
                        <span className='img-wrap'>
                            <Image src="https://image.mysuni.sk.com/suni-asset/public/images/all/foundationSkill-info.png" alt="FundationSkill 구성" />
                        </span>
                    </div>
                    }
