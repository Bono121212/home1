...
import { Button, Form, Icon, Popup, Progress } from "semantic-ui-react";
                ...
                <Form>
                    <Form.Field>
                        ...
                        <div className="ui action input file_input">
                            <input readOnly placeholder="" type="text" />
                            ...
                            <div className="file_name_list">
                                ...
                                <a href={()=>false} className="del"><Icon className="del"/></a>
                            </div>
                        </div>
                    </Form.Field>
                    <Form.Field className="flex sp_bt">
                        ...
                        <div className="ui action input file_input">
                            ...
                            <div className="progress_bar_area">
                                ...
                                <a href={()=>false} className="cncl">등록취소</a>
                            </div>
                        </div>
                        <div className="ui action input file_input">
                            <input readOnly placeholder="" type="text" />             
                            ...
                            <div className="progress_bar_area">
                                {/* <span>0%</span>
                                <Progress percent={80} size="tiny" className="orange"/> */}
                                <a href={()=>false} className="done" aria-disabled>등록완료</a>
                            </div>
                        </div>
                        <div className="ui action input file_input">
