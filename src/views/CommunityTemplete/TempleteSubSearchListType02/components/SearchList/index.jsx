                        ...
                        <Table.Row>
                            <Table.Cell className="title">
                                <div className="t_inner important new">
                                    ...
                                    <Link to="" className="ellipsis">[공지] TRENDING 정보게시판 이용안내, 자세한 내용을 이야기해보도록합니다. 1줄이상인경우 말줄임이됩니다</Link>
                                    <span className="reply">[<strong>12</strong>]</span>
                                    <Icon className="secret" />
                                </div>
                                <div className="result_text">
                                    <p className="ellipsis">게시글의 상세내용 중에 검색결과가 표시되는데 <span className="red">즉시검색 결과표시</span> 됩니다. 앞뒤 상세내용이 30자씩 보여진 후 줄임표시됩니다</p>
                                </div>
                            </Table.Cell>
