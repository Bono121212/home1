...
class CVod2A extends Component {

    render() {
        return (
            <div className="compo_vod compo2">
                <Link to="/">
                    ...
                    <div className="compo_info">
                        ...
                        {/* 변경내역 */}
                        {/*  
                        <p className="info_body"> 에 new클래스 여부에 따라 [n] 아이콘이 노출/비노출 됩니다
                        <span className="ellipsis">
                        */}
                        <p className="info_body new">
                        <span className="ellipsis2">프로축구 K리그!</span>
                        </p>
