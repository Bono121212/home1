...
class CTxtList4B extends Component {


    render() {
        return (
            <div className="compo_txt_card compo4">
                <Link to="/">
                    <div className="compo_info">
                        {/* <strong className="title ellipsis2">[공지] 3rd Letter : 2주 동안의</strong> */}
                        {/* 변경내역 */}
                        {/*
                        ...
                        */}
                        ...
                        <strong className="title new">
                            <span className="ellipsis2">[공지] 3rd Letter : 2주 동안의</span>
                        </strong>
                        <p className="txt ellipsis2">게시글의 상세내용이 두 줄까지 보입니다.</p>
                    </div>
