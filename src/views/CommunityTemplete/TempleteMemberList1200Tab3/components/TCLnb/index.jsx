                ...
                <div className="tc_lnb_inner">
                    ...
                    <div className="tc_lnb">
                        <List as="ul" className="">
                            ...
                            <List.Item as="li" value="*" className="active"><Link to="/">Trending 정보</Link>
                                <div className="tc_lnb_sub">
                                    {/* <strong className="sub_tit">Trending 정보</strong> */}
                                    <List as="ul">
                                        <List.Item as="li" value="-" className="active"><Link to="/">멤버</Link> </List.Item>
                                        <List.Item as="li" value="-"><Link to="/">메뉴2</Link> </List.Item>
                                        <List.Item as="li" value="-"><Link to="/">메뉴3</Link> </List.Item>
                                        <List.Item as="li" value="-" className="new"><Link to="/">메뉴 메뉴 메뉴 메뉴 메뉴 메뉴 메뉴 메뉴 메뉴 메뉴 메뉴 메뉴 메뉴 메뉴 메뉴 메뉴 4</Link> </List.Item>
                                    </List>      
                                </div>                        
                            </List.Item>
