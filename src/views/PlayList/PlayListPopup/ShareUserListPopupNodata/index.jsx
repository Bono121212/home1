...
class ShareUserListPopupNodata extends Component{
    state = {isOpen :true}
                    ...
                    <div className='inner scrolling-40vh'>
                        <div className='sh-user-list'>
                            ...
                            <div className="no-cont-wrap">
                                ...
                                <div className="text">추천받은 구성원이 없습니다.</div>
                                {/* <div className="text">담아간 구성원이 없습니다.</div> */}
                            </div>
...
export default ShareUserListPopupNodata;