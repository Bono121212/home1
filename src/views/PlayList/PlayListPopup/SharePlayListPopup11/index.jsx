...
class SharePlayListPopup11 extends Component {
    
    state = {isOpen :true,focus: false} 
                    ...
                    <div className='inner scrolling-80vh'>
                        ...
                        <div className='sh-bottom'>
                            ...
                            <div className='ui right-top-count input error'>
                                <span className="count"><span className="now">50</span>/<span className="max">50</span></span>
                                <input type="text" value={`일이삼사오륙칠팔구십일이삼사오륙칠팔이십일이삼사오륙칠팔삼십일이삼사오륙칠팔사십일이삼사오륙칠팔오십`} placeholder="Playlist와 함께 추천할 메시지 내용을 입력해주세요."/>
...
export default SharePlayListPopup11;
