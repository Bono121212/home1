...
import {NoData, PlaylistAllTopNoData, CommentsSort, ClearInputBox} from './components'
import './style.css';

class PlaylistListAllNoData extends Component {
                                ...
                                <div className='playlist-view-tabpanel'>
                                    <div className="list-top">
                                        <div className="list-top-left">
                                            <div>총 <strong>0개</strong>의 Playlist가 있습니다.</div>
                                        </div>
                                    ...
                                    {/* No Data 일때 */}
                                    { this.state.boardType==='card' ? <NoData message="검색한 Playlist가 없습니다." /> : <NoData message="등록된 Playlist가 없습니다." /> }
...
export default PlaylistListAllNoData;