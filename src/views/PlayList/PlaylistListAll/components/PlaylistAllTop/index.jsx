            ...
            <Swiper {...PlaylistTopListParams}>
                <div className="swiper-slide">
                    ...
                    <div className='playlist-top-body'>
                        ...
                        <ul className='playlist-top-list'>
                            <li><Link to='/playlist/playlist-detail-otherlist'>이천포럼 다시보기</Link></li>
                            <li><Link to='/playlist/playlist-detail-mylist'>AI 아싸(Outsider)에서  AI 핵인싸로 업그레이드</Link></li>
                            <li><Link to='/playlist/playlist-detail-mylist'>우리팀 마음근력 키우기</Link></li>
                        </ul>
                        <div className='playlist-top-title'>
                ...
                <div className="swiper-slide">
                    ...
                    <div className='playlist-top-body'>
                        ...
                        <ul className='playlist-top-list'>
                            <li><Link to='/playlist/playlist-detail-otherlist'>AI 아싸(Outsider)에서  AI 핵인싸로 업그레이드</Link></li>
                            <li><Link to='/playlist/playlist-detail-mylist'>[TM Speech] P4G 서울 정상회의를 진행합니다.</Link></li>
                            <li><Link to='/playlist/playlist-detail-mylist' className='no-link'>-</Link></li>
                        </ul>
                    </div>
                </div>
