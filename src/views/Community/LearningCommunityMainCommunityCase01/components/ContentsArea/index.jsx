...
import CompleteStateCard from "../CompleteStateCard";
                    ...
                    <div className="contents">
                        ...
                        <div className="community-cont">
                            <div className="community-list">
                                ...
                                <div className="depth1">
                                    <span className="del">
                                        <Icon className='listdel24'/><span className="blind">삭제됨</span>
                                        <span>삭제된 글입니다.</span>
                                    </span>
                                </div>
                                <div className="depth1">
                                    <Link to="#">
                                        ...
                                        <span className="view">3,333 읽음</span>
                                        <span className="date">2020.01.15</span>
                                    </Link>
                                </div>
                                <div className="depth2">
                                    ...
                                    <Link to="#">
                                        <span className="title">
                                            ...
                                            <span className="rep-num">[<strong>99+</strong>]</span>
                                        </span>
                                        <span className="writer">홍길동</span>
                                        <span className="view">333 읽음</span>
                                        <span className="date">2020.01.15</span>
                                ...
                                <div className="depth1">
                                    <Link to="#">
                                        <span className="title">
                                            <span className="ellipsis">사회적 가치 실현을 위한 DBL Doble Bottom Lin사회적 가치 실현을 위한 DBL Doble Bottom Lin사회적 가치 실현을 위한 DBL Doble Bottom Lin사회적 가치 실현을 위한 DBL Doble Bottom Lin사회적 가치 실현을 위한 DBL Doble Bottom Lin사회적 가치 실현을 위한 DBL Doble Bottom Lin사회적 가치 실현을 위한 DBL Doble Bottom Lin사회적 가치 실현을 위한 DBL Doble Bottom Lin사회적 가치 실현을 위한 DBL Doble Bottom Line</span>
                                            <span className="rep-num">[<strong>99+</strong>]</span>
                                        </span>
                                        <span className="writer">홍길동동</span>
                                        <span className="view">3,333 읽음</span>
                                ...
                                <div className="depth1">
                                    <Link to="#">
                                        <span className="title">
                                            <span className="ellipsis">질문은 안 받아요</span>
                                            <span className="rep-num">[<strong>3</strong>]</span>
                                        </span>
                                        <span className="writer">홍길동</span>
                                        <span className="view">123 읽음</span>
                                        <span className="date">2020.01.15</span>
                                    </Link>
                                </div>
                                <div className="depth2">
                                    <Link to="#">
                                        <span className="title">
                                            <Icon className='reply16-b'/><span className="blind">reply</span>
                                            <span className="ellipsis">질문있어요!!! 질문!!</span>
                                        </span>
                                        <span className="writer">홍길동</span>
                                        <span className="view">0 읽음</span>
                                        <span className="date">2020.01.15</span>
                                    </Link>
                                    <Link to="#">
                                        <span className="title">
                                            <Icon className='reply16-b'/><span className="blind">reply</span>
                                            <span className="ellipsis">저한테 댓글 달지 마세요</span>
                                            <span className="rep-num">[<strong>50</strong>]</span>
                                        </span>
                                        <span className="writer">홍길동</span>
                                        <span className="view">50 읽음</span>
                                        <span className="date">2020.01.15</span>
                                    </Link>
                                </div>
                            </div>
