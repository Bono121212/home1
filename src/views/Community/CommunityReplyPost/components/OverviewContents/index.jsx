                            ...
                            <div className="detail">
                                <div className="file-down-wrap">
                                    ...
                                    <div className="all-down">
                                        <a href={()=>false}>
                                            <Icon className="icon-down-type4"/><span>전체 다운로드</span>
                                        </a>
                                    </div>
                                </div>
                            </div>
         ...
         */}
                    ...
                    <List>
                        ...
                        <List.Item>
                            ...
                            <div className="detail">
                                ...
                                <div className="info">Cancellation penalty : 20% of the lecture fee and no application for training for three months </div>
                            </div>
                        </List.Item>
                    </List>
                </div>
                ...
                <div className="ov-paragraph">
                    ...
                    <div className="series-wrap">
                        <h3 className="title-style">
                            <Label className='onlytext bold size24'>
                                <Icon className='series'/><span>{/* Class Series */}차수정보</span>
                            </Label>
                        </h3>
                        ...
                        <Table celled>
                            ...
                            <Table.Body>
                                <Table.Row>
                                    ...
                                    <Table.Cell className="teacher"><span>손흥민이이이이</span></Table.Cell>
                                    <Table.Cell className="location"><span>SKSK planet 본사 4층 미팅룸SK planet 본사 4층 미팅룸 planet 본사 4층 미팅룸</span></Table.Cell>
                                    <Table.Cell className="center">2019. 01. 02 ~ 2019. 02. 24</Table.Cell>
                                    <Table.Cell className="center">2019. 01. 02 ~ 2019. 02. 24</Table.Cell>
                                </Table.Row>
                                <Table.Row>
                ...
                <div className="ov-paragraph info-box2">
                    <List bulleted>
                        ...
                        <List.Item>
                            ...
                            <div className="detail">주말 학습장소는 주차공간이 협소하니 대중교통을 이용해 주시기 바랍니다. 주말 학습장소는 주차공간이 협소하니 대중교통을 이용해 주시기 바랍니다. 주말 학습장소는 주차공간이 협소하니 대중교통을 이용해 주시기 바랍니다. 주말 학습장소는 주차공간이 협소하니 대중교통을 이용해 주시기 바랍니다.</div>
                        </List.Item>
                    </List>
                </div>
