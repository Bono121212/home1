...
class OpenCard07 extends Component {
    render() {
        return (
            <div className="community-open-card coc_v2">  { /* coc_v2 클래스 추가되었습니다. */}
                <div className="open-card-top">
                    ...
                    <div className="iconbox">
                        ...
                        <span className="waiton">가입대기</span>

                        {/* 비공개 커뮤니티 보이기 : lockon 클래스, 비공개 커뮤니티 숨기기 : lockoff 클래스 */}
                        <span className="lockoff"><Icon><Image src={lock} alt="비공개"/></Icon></span>
                ...
                <a href={()=>false} className="open-card-content">
                    <p>데이터 혁신이 답이다 데이터 혁신이 답이다 데이터 혁신이 답이다 하하하하하하하하하하</p>
