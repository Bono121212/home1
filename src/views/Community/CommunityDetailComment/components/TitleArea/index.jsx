            ...
            <div className="post-view">
                <div className="title-area">
                    <div className="title-inner">
                        <div className="community-name">사회적 가치(SV) 모임</div>
                        <div className="title">사회적 기업의 생태계 조성 SPC : SK는 DBL 추구를 통해 사회적 가치를 담아낼 수 있는 형태로 비즈니스 모델(Business
                            Model, BM)의 혁신을 진행하고 있습니다.
                        </div>
                        ...
                        <div className="actions">
                            ...
                            <Button icon className='left postset commu-list16'><Icon
                                className='commu-list16'/>List</Button>
                        </div>
                    </div>
                </div>
