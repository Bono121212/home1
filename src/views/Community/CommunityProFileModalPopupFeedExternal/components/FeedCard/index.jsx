            ...
            <Comment.Content>
              ...
              <Comment.Actions>
                <div className="action-area">
                  <Link to="#" icon><i className="icon popupUrl" /></Link>
                  <Button icon><i className="icon popupBook marking" /></Button>{/* bookmark추가시 class 'marking' 삭제*/}
                </div>
              </Comment.Actions>
            </Comment.Content>
          </Comment>
          <div className="feed-card">
            <Accordion>
              ...
              >
                ...
                <Link>숏폼 플랫폼인 Quibi 서비스가 론칭되었다 게시물 제목이 긴 경우에는 어떻게 되는 지 한번 알아보자</Link>
            ...
            <Comment.Content>
              ...
              <Comment.Text>
                <div className="ellipsis">
                  ...
                  <span className="line like">좋아요{' '}<strong>0</strong></span>
                  <span className="line comt">댓글수{' '}<strong>0</strong></span>
                </div>
              </Comment.Text>
              <Comment.Actions>
                <div className="action-area">
                  <Link to="#" icon><i className="icon popupUrl" /></Link>
                  <Button icon><i className="icon popupBook" /></Button>{/* bookmark추가시 class 'marking' 삭제*/}
                </div>
              </Comment.Actions>
            </Comment.Content>
          </Comment>
        ...
        <Comment.Group className="base">
          ...
          <div className="feed-card">
            <Accordion>
              ...
              >
                <span className="ico_feed board">게시물</span>
                <Link>애플의 황이석 교수의 Financial Acumen 스트리밍 서비스</Link>
                <span className="ico_feed file blind">첨부파일</span>
                <i aria-hidden="true" class="dropdown icon"></i>
              </Accordion.Title>
