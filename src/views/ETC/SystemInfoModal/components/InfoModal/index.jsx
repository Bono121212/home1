    ...
    render() {
        ...
        return (
            <>
                ...
                <Modal size={size} open={open} onClose={this.close} className='w824 base'>
                    <Modal.Content>
                        <div className="scrolling-80vh">
                            <div className="content-wrap5">
                                <div className="system-message">
                                    <div className="tit">
                                        <i className="sk-university-login icon"><span
                                            className="blind">mySUNI</span></i> 시스템 안내
                                    </div>
                                    <div className="box1">
                    ...
                    <Modal.Actions className="actions4">
                        <div className="left">
                            <Checkbox label='이창 다시보지 않기' className='base'/>
                        </div>
                        <div className="right">
