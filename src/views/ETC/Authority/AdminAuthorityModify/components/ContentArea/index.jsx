...
const ContentArea = (props) => {
    ...
    const [input1Write, setInput1Write] = useState("부서를 옮겨서 다시금 권한 신청합니다.\n가능한 한 빠른 승인 부탁드립니다.");
	const [input1Lenth, setInput1Lenth] = useState(0);

	// Radio
	const [radioVal, setRadioVal] = useState("radio01");
			...
			<div className="regi-form base">
				<Form className="regi-content">
						...
						<Table>
							...
							<TableBody>
								<Table.Row>
									...
									<Table.Cell>Company Contents Manager</Table.Cell>
								</Table.Row>
								<Table.Row>
					...
					<div className="button-area">
						<button type='button' className="ui button bg fix" disabled>수정</button>
					</div>
				</Form>
			</div>
		</div>
