                ...
                <div className="result_contents w50">
                    <div className="teacherbox">
                        ...
                        <dl className="search_detail flex">
                            ...
                            <dt>강의 분야</dt>
                            <dd className="ellipsis">데이터 <strong className="search_keyword">분석</strong> </dd>
                            <dt>주요 경력</dt>
                ...
                <div className="result_contents w50">
                    <div className="teacherbox">
                        <Link to="/" className="flex">
                            ...
                            <div className="t_name">
                                <strong className="ellipsis">송 데이터 <strong className="search_keyword">분석</strong></strong>
                        ...
                        <dl className="search_detail flex">
                            ...
                            <dt>강의 분야</dt>
                            <dd className="ellipsis">마케팅, 고객관계관리(CRM), 빅 데이터 <strong className="search_keyword">분석</strong> 혁신 사업본부 마케팅, 고객관계관리(CRM), 빅</dd>
                            <dt>주요 경력</dt>
                ...
                <div className="result_contents w50">
                    <div className="teacherbox">
                        <Link to="/" className="flex">
                            <Image src={SThumb1} className="t_thumb" alt="강사이미지" />
                            <div className="t_name">
                                <strong className="ellipsis">최 데이터 <strong className="search_keyword">분석</strong>선희최선희</strong>
                                <span className="ellipsis">명예교수</span>
                            </div>
                        </Link>
                        <dl className="search_detail flex">
                ...
                <div className="result_contents w50">
                    <div className="teacherbox">
                        <Link to="/" className="flex">
                            <Image src={SThumb3} className="t_thumb" alt="강사이미지" />
                            <div className="t_name">
                                <strong className="ellipsis">최<strong className="search_keyword">분석</strong>선희최선희</strong>
                                <span className="ellipsis">명예교수</span>
                            </div>
                        </Link>
                        <dl className="search_detail flex">
