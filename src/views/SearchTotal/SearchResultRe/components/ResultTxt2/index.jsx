            ...
            <div className="result">
                ...
                <div className="result_contents">
                    <div className="search_title">
                        <Link to="/">'21년 상반기 제조/기술 데이터 <strong className="search_keyword">분석</strong> 리더십 Essential (1차수)</Link>
                ...
                <div className="result_contents">
                    <div className="search_title">
                        ...
                        <p className="search_detail">
                            [Hubert의 애자일 이야기] #8-2 우리는 어떤 회사에서 일하고 있나?( 데이터 기반
                ...
                <div className="result_contents">
                    <div className="search_title">
                        ...
                        <p className="search_detail">
                            2021 커뮤니티 알림 데이터 <strong className="search_keyword">분석</strong>테스트
                        </p>
                    </div>
                </div>
            </div>
