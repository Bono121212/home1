        ...
        return (
            <div className="result">
                ...
                <div className="result_contents">
                    ...
                    <div className="search_title">
                        <Link to="/"><span>NoSQL 이해와 활용 <strong className="search_keyword">데이터</strong>1 (What is NoSQL)</span></Link>
                        <p className="search_detail">SK 관계사의 고객 기반 혁신 현장을 가다!! ‘SK의 고객 마케팅 프랙티스’ [과정개요]  - SKT ICT패밀리, SK브로드</p>
                    </div>
                    <div className="tagbox">
                        <strong>태그,</strong>
                        <div>
                            <span>태블로 마스터,</span>
                            <span><strong className="search_keyword">데이터</strong>분석</span>
                        </div>
                    </div>
                </div>
                ...
                <div className="result_contents">
                    <div className="sortbox">
                        ...
                        <span>DT Biz. & Implementation Channel</span>
                    </div>
                    <div className="search_title">
                        <Link to="/"><span><strong className="search_keyword">데이터</strong>3법, SK 구성원이 묻고 답하다</span></Link>
                        <p className="search_detail"><strong className="search_keyword">데이터</strong> 3법에 대한 일반 구성원 인식 제고 및 관계사 담당자들의 전문성 강화를 위해 사내외 전문가를 모시고 의견을 들어보았습니다.</p>
                    </div>
                    <div className="tagbox">
                        <strong><strong className="search_keyword">데이터</strong>3법,</strong>
                        <div>
                            <span>가명정보,</span>
                            <span>가명 정보 결합,</span>
                            <span>금융 MYDATA,</span>
                            <span>개인의 자기정보 결정권</span>
                        </div>
                    </div>
                </div>
                ...
                <div className="result_contents">
                    ...
                    <div className="search_title">
                        <Link to="/"><span>NoSQL 이해와 활용 1 (What is NoSQL)</span><span>Tableau Basic - 첫걸음 ③ 데이터 작업하기</span></Link>
                        <p className="search_detail">SK 관계사의 고객 기반 혁신 현장을 가다!! ‘SK의 고객 마케팅 프랙티스’ [과정개요]  - SKT ICT패밀리, SK브로드</p>
                    </div>
                    <div className="tagbox">
                        <strong>태그,</strong>
                ...
                <div className="result_contents">
                    ...
                    <div className="search_title">
                        <Link to="/"><span>NoSQL 이해와 활용 1 (What is NoSQL)</span><span>[<strong className="search_keyword">데이터</strong> 시각화] Tableau 지식인</span></Link>
                        <p className="search_detail">SK 관계사의 고객 기반 혁신 현장을 가다!! ‘SK의 고객 마케팅 프랙티스’ [과정개요]  - SKT ICT패밀리, SK브로드</p>
                    </div>
                    <div className="tagbox">
                        <strong>태그,</strong>
