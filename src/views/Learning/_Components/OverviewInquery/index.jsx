...
import AplFormWrap from "../OverviewInqueryForm/AplFormWrap";

const OverviewInquery = (props) => {
    ...
    return (
        // 265(푸터높이) + 50(플로팅간격)
        <div className="inquery-floating" style={{ "bottom": ((props.scrollBottom > 0) ? (props.scrollBottom + 50) + "px" : '32px') }}>
            <Modal
                trigger={
...
export default OverviewInquery;
