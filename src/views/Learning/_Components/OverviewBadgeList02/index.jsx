        ...
        <div className="ov-badge-list">
            <Link to="/" className="badge-item">
                ...
                <div className="badge-cont">
                    ...
                    {/* badge-status > challenging : 도전중, blind : 도전전 / link */}
                    <div className="badge-status challenging">
                        <span>도전중 <em>1</em>/3</span>
                    </div>
                </div>
            </Link>
            <Link to="/" className="badge-item">
            ...
            <Link to="/" className="badge-item">
                ...
                <div className="badge-cont">
                    <p className="tit">Global_중국_Advanced</p>
                    {/* badge-status > challenging : 도전중, blind : 도전전 / link */}
                    <div className="badge-status challenging">
                        <span>도전중 <em>2</em>/3</span>
                    </div>
                </div>
            </Link>
        </div>
...
export default OverviewBadgeList02;