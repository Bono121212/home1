...
import ReportMgmtWrap from './components/ReportMgmtWrap';
import ReportDetailWrap from './components/ReportDetailWrap';

const CubeAssignmentReportFail = () => {
	// Layout
			...
			<div className="cube-info-detail">
				...
				<div className="cube-detail-body">
					...
					<CubeDetailSec className="cube-sec cube-assignment-sec">
						<ConditionsDetailReport state="fail" />
						<ReportDetailWrap />
						<ReportMgmtWrap />

						<div class="page-action">
							<button class="ui button fix bg">다시제출</button>
						</div>
					</CubeDetailSec>
				</div>
				{/* 문의하기 플로팅 영역 */}
...
export default CubeAssignmentReportFail
