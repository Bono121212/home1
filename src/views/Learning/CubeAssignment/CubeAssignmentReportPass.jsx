...
const CubeAssignmentReportPass = () => {
	// Layout
	...
	return (
		<section className={scrollValue > 113 ? 'content lms lms-lnb-fixed ' + (isFold ? 'v-wide' : '') : 'content lms lms-lnb-static ' + (isFold ? 'v-wide' : '')}>
			...
			<div className="cube-info-detail">
				{/* Cube Detail Header */}
				<CubeDetailHeader02
					title="현재 수행 또는 계획 중인 업무를 린보드 5개 항목에 맞춰 가설을 정리하여 작성해 보세요." cube="Assignment" time="16h 10m" state="학습완료"
				...
				<div className="cube-detail-body">
					...
					<CubeDetailSec className="cube-sec cube-assignment-sec">
						<ConditionsDetailReport state="pass" />
						<ReportDetailWrap />
					</CubeDetailSec>
				</div>
				{/* 문의하기 플로팅 영역 */}
...
export default CubeAssignmentReportPass
