...
class LearningCardMissed extends Component {
    constructor() {
        super();
        this.state = {
            isHovered: false
                ...
                <Card className={`card-h ${activeClass}`} onMouseEnter={() => this.handleHover(true)}
                    ...
                    <div className="card-inner">
                        ...
                        <div className="foot-area">
                            <Label className='bold onlytext'>
                                <Icon className='state'/><span>{/* Missed */}취소/미이수</span>
                            </Label>
                            <div className="study-date">2019.10.10 학습 이수 실패</div>
                        </div>
...
export default LearningCardMissed
