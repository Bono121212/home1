          ...
          <div className="course-detail-center community-containter">
            ...
            <div className="community-home-contants">
              ...
              <div className="my-commu-table">
                <table>
                  <tbody>
                    ...
                    <tr>
                      <th>관리자 정보</th>
                      <td>
                        <div className="home-detail-profile no-pic">
                          <span className="crown">nickname</span>
                        </div>
                        <div className="home-detail-profile no-pic">
                          <span className="co_crown">앤이즈백</span>
                        </div>
                        <div className="home-detail-profile no-pic">
                          <span className="co_crown">sehoo</span>
                        </div>
                      </td>
                    </tr>
                    <tr>
                ...
                <button type="button" className="ui button sece_btn_new">
                  <img src={out} alt=""/>
                  <span>탈퇴하기</span>
                </button>
              </div>
