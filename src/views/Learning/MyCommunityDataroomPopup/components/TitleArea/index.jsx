        ...
        <div className="main-info-wrap">
          ...
          <div className="title-area">
            ...
            <div className="header">
              Open Source를 활용한 Big Data 기반 플랫폼을 이용한 데이터 분석
            </div>
            <div className="deatil">
              <div className="item">
                <Label className="bold onlytext">
                  <Icon className="video2" />
                  <span>Classroom</span>
                </Label>
              ...
              <div className="item">
                <Label className="onlytext">
                  <Icon className="date" />
                  <span>등록일 : 2019.12.31</span>
                  <span className="ml17">
                    {/* Study start date, end date */}학습기간 : 2019.12.31
                    20:30 ~ 2020.02.20 09:00
                  </span>
                </Label>
              </div>
            </div>
