...
import BlendedHeader from "./components/BlendedHeader";
import BlendedSectionPlayer from "./components/BlendedSectionPlayer";
import BlendedSectionData from "./components/BlendedSectionData";
import BlendedSectionDocument from "./components/BlendedSectionDocument";
import BlendedSectionWebpage from "./components/BlendedSectionWebpage";
import BlendedSectionDiscussion from "./components/BlendedSectionDiscussion";

const CubeBlendedChapter = () => {
	// Layout
...
export default CubeBlendedChapter
