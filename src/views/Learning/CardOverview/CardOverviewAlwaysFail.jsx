...
import OverviewCurriculumAlways from "../_Components/OverviewCurriculumAlways";
...
// import OverviewCurriculumSingleAlwaysFail from "../_Components/OverviewCurriculumSingleAlwaysFail";
// import OverviewInquery from "../_Components/OverviewInquery";
import { Link } from 'react-router-dom';

const CardOverviewAlways = () => {
	// Tabmenu
	...
	return (
		<section className={scrollValue > 113 ? 'content lms lms-lnb-fixed ' + (isFold ? 'v-wide' : '') : 'content lms lms-lnb-static ' + (isFold ? 'v-wide' : '')}>
			...
			<div className="cube-info-detail type-ov type-only">
				{/* Cube Detail Header */}
				<CubeDetailHeader
					backgroundImage="http://placeimg.com/1920/260/nature" backgroundColor="#ac5fd6"
				...
				{/* 과정정보 학습하기 플로팅 영역(미이수 비노출) */}
				{/* <OverviewCurriculumSingleAlwaysFail scroll={scrollValue} scrollBottom={scrollBottomValue} /> */}
...
export default CardOverviewAlways;
