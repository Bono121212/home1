...
import SurveyGuideWrap from './components/SurveyGuideWrap';
...
const CubeSurvey = () => {
	...
	return (
		<section className={scrollValue > 113 ? 'content lms lms-lnb-fixed ' + (isFold ? 'v-wide' : '') : 'content lms lms-lnb-static ' + (isFold ? 'v-wide' : '')}>
			...
			<div className="cube-info-detail cube-survey-detail">
				{/* Cube Detail Container */}
				<div className="cube-detail-body">
					<SurveyGuideWrap case="all" />
				</div>
			</div>
		</section>
	)
};
export default CubeSurvey
