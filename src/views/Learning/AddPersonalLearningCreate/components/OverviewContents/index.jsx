    ...
    return (
      <div className="contents overview">
        ...
        <div className="class-guide-txt">
          ...
          <br />
          이 과정을 통해 당신은 당신의 CV에 UX 디자이너를 추가하고 당신의 새로운
          기술에 대한 보수를 받기 시작할 수 있을 것입니다.
          <br />
          <br />
          안녕하세요. 내 이름은 홍길동이며, Adobe Certified 강사입니다. 어도비
          XD를 효율적이고 포괄적으로 배울 수 있도록 도와주러 이 강좌를
          개설하였습니다. XD는 업계 전문가들이 고품질의 기능성 모형을 생산하기
          위해 사용하는 환상적인 디자인 도구입니다. 본 코스를 통해 실용적이고
          효과적인 UX(User Experience) 및 UI(User Interface) 설계를 제작할 수
          있습니다.
        </div>
        {/* 파일다운로드 (선택) */}
        ...
        <div className="ov-paragraph sub-category fn-parents">
          ...
          <List bulleted>
            ...
            <List.Item>
              ...
              <div className="detail">
                ...
                Pipeline / Leadership Clinic Leadership / Leading Myself /
                Leading Business / Leadership Pipeline
              </div>
            </List.Item>
            <List.Item>
          ...
          <Button icon className="right btn-blue btn-more fn-more-toggle">
            more <Icon className="more2" />
          </Button>
          <Button icon className="right btn-blue btn-hide fn-more-toggle">
          ...
          <div className="ui bulleted list">
            ...
            <div className="item">
              ...
              <div className="detail">
                ...
                바랍니다. 주말 학습장소는 주차공간이 협소하니 대중교통을 이용해
                주시기 바랍니다. 주말 학습장소는 주차공간이 협소하니 대중교통을
