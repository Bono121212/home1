...
const PlayerVideo = (props) => {
	...
	const handlerPipClose = () => {
		document.querySelector('.cube-info-detail').classList.add("is-video-pip-hidden");
		document.querySelector('.lms-video-sticky').classList.add("is-video-pip-hidden");
	}
	useEffect(() => {
		if (props.scrollValue > props.stickyValue) {
			document.querySelector('.cube-info-detail').classList.add("is-video-pip");
			document.querySelector('.lms-video-sticky').classList.add("is-video-pip");
		} else {
			document.querySelector('.cube-info-detail').classList.remove("is-video-pip");
