...
const selectOptions02 = [
  { key: "all", value: "all", text: "10개씩 보기" },
    ...
    return (
      <div className="table-board-title">
        ...
        <Select
              ...
              />
              <button class="ui button admin_table_button" disabled="" tabindex="">그룹장 지정</button>
              <button class="ui button admin_table_button" disabled="" tabindex="">그룹 멤버 추가</button>
