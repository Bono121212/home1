    ...
    return (
      <div className="table-board-title">
        ...
        <Select
              ...
              />
              <button class="ui button admin_table_button" disabled="" tabindex="">가입 승인</button>
              <button class="ui button admin_table_button02" disabled="" tabindex="">가입 반려</button>
        </div>
      </div>
    );
  }
