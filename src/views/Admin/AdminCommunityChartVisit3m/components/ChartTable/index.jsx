    ...
    render(){
        return(
          <Table className="chart-table">
            ...
            <Table.Body>
              <Table.Row>
                <Table.Cell>2021.05.11</Table.Cell>
              ...
              <Table.Row>
                <Table.Cell>2021.05.09</Table.Cell>
                <Table.Cell>일요일</Table.Cell>
                <Table.Cell>1,234</Table.Cell>
              </Table.Row>
              <Table.Row>
                <Table.Cell>2021.05.08</Table.Cell>
              ...
              <Table.Row>
                <Table.Cell>2021.05.06</Table.Cell>
                <Table.Cell>목요일</Table.Cell>
                <Table.Cell>16</Table.Cell>
              </Table.Row>
              <Table.Row>
                <Table.Cell>2021.05.05</Table.Cell>
                <Table.Cell>수요일</Table.Cell>
                <Table.Cell>13</Table.Cell>
              </Table.Row>
              <Table.Row>
              ...
              <Table.Row>
                <Table.Cell>2021.05.03</Table.Cell>
                <Table.Cell>월요일</Table.Cell>
                <Table.Cell>1,234</Table.Cell>
              </Table.Row>
              <Table.Row>
                <Table.Cell>2021.05.02</Table.Cell>
                <Table.Cell>일요일</Table.Cell>
                <Table.Cell>1,234</Table.Cell>
              </Table.Row>
            </Table.Body>
