        ...
        return (
            <div className="ta_lnb_area">
                <List as="ul" className="ta_lnb">
                    <List.Item as="li"><Link to="/" className="list_item"><Icon className="i_board"/><span className="ellipsis new">공지사항</span></Link></List.Item>
                    ...
                    <List.Item as="li">
                        <Accordion>
                            ...
                            >
                                <span className="list_item"><Icon className="i_board"/><span className="ellipsis new">딥 러닝의 중요성</span></span>
