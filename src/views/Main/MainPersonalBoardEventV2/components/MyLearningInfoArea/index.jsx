...
import BtnEvent from "../../../../../images/all/BNR_Summer_Event.gif";
        ...
        <div className="main-personal-wrap">
            <div className="main_personal">
                ...
                <div className="main-event-btn2">
                    ...
                    >
                        <Image src={BtnEvent} alt="다시 돌아온 출석이벤트"/>
                    </Button>
                </div>

                {/* 7월 출석이벤트 팝업 */}
                {
                    popup && <ClassSeriesDetailModal />
                }
                    ...
                    <div className="card-gauge-bar">
                      ...
                      <div className="card-gauge-bar sty2">
                        <div className="rangeBox">
                          <div class="range">
                            <div
                              style={activeIndex !== 0 || -1 ? {width: '30%'} : {width: 0}}
                              className="percent"
                            ></div>
                          </div>
                        </div>
