...
class CardValueDefault02 extends Component {
    constructor() {
        super();
        this.state = {
            isHovered: false
    ...
    render() {
        ...
        return (
            <Card className={`card-item card-item-02 ${activeClass}`} onMouseEnter={() => this.handleHover(true)}
                    ...
                    <div className="thumbnail-area">
                        ...
                        <div className="thumb-info top">
                            <div className="txticon-wrap">
                                <Label className='day'><div className="custom-icon icon-clock"></div><span>3일 남음</span></Label>
                            </div>
                        </div>
                        <div className="thumb-info bottom">
                            <Label><span>10h 42m</span></Label>
                        </div>
                    </div>
                    <div className="contents-area">
                        <div className="title-area">
                            <div className="status">
                                ...
                                <Label className="my-stat before"><span>학습전</span></Label>
                            </div>
                            <div className="header">[지정학적 변화진단] 포스트 코로나, 새로운 질서의 시작</div>
                        </div>
                        <div className="icon-area txticon-wrap bottom">
                            <div className="f-left">
                                <Label>
                                    <div className="custom-icon icon-user"></div><span>1만</span>
                                </Label>
                            </div>
                            <div className="f-right">
                                <Label>
                                    <div className="custom-icon icon-star"></div><span>3.9</span>
                                </Label>
                            </div>
                        </div>
                    </div>
...
export default CardValueDefault02