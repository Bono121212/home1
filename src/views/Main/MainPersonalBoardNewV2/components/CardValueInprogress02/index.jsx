...
class CardValueInprogress01 extends Component {
    ...
    render() {
        ...
        return (
            <Card className={classNames(`card-h ${activeClass}`,"on")} onMouseEnter={() => this.handleHover(true)}
                ...
                <div className="hover-content">
                    {/* 변경, title-area 삭제하셔도 되고 삭제안하셔도 됩니다.
                    <div className="title-area">
                        <Label color='blue'>Leadership</Label>
                        <div className="header">Affiliate Marketing Masterclass: Newbie to Advanced Bootcamp</div>
                    </div> */}
                    ...
                    <p className="text-area">
                        ...
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Eaque, exercitationem suscipit. Blanditiis in sequi accusamus neque culpa consectetur voluptatum cum quis ea!
                    </p>
