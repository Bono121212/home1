...
class ProfileCardGlb extends Component {
    state = {open: true};
            ...
            <>
                <div className="profile-contents-area">
                            ...
                            <div className="profile-info-wrapper">
                                <div className="profile-info-area">
                                    ...
                                    <div className="profile-info ">
                                        <span className="prof-tit">KIM SUNI</span>                                        
                    ...
                    <div className="bottom-bttn-area">
                        <ul>
                            <li><Button className="b-menu">Instructor</Button></li> 
                            <li><Button className="b-menu on">Approval</Button></li>{/* 새로운 게시글 on */}
