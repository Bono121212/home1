            ...
            <>
                ...
                <div className="my-learning-area">
                    <Segment className="full">
                        <div className="table-css type2">{/* .type1, .type2 //*/}
                            <div className="row">
                        ...
                        <div className="ui tab-menu">
                            <div className="cont-inner">
                                <div className="ui sku menu">
                                    <a className="item" data-tab="first">
                                        권장과정
                                        {/*Required*/}
                                        <span className="count">+5</span>
                                    </a>
                                    <a className="active item" data-tab="second">
                                        관심목록
                                        {/*In My List*/}
                    ...
                    <div className="ui full segment">
                        <div className="ui active tab" data-tab="first">
                            ...
                            <div className="no-cont-wrap">
                                ...
                                <div className="text">관심목록에 추가된 학습 과정이 없습니다.</div>
                        ...
                        <div className="recommend-head">
                            ...
                            <div className="right">
                                <Button icon className="img-icon">
                                    <span className="underline">현재 선택된 관심 Channel(<span className="sel">24</span>/80)</span>
