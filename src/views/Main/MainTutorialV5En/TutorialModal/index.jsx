...
class TutorialModal extends Component {
    ...
    render() {
        ...
        return (
            <>
                <Modal size={size} open={open} className='base tutorials5 front scrolling en'>
                            ...
                            <div className="cont-wrap">
                                <div className="cont-nav">
                                    <div className="tuto-nav">
                                        <Link className={classNames('item tu1',activeMenu==='tu01' ? 'current' : '')} onClick={()=>this.setState({activeMenu: 'tu01'})}>mySUNI App Update</Link>
                                        <Link className={classNames('item tu2',activeMenu==='tu02' ? 'current' : '')} onClick={()=>this.setState({activeMenu: 'tu02'})}>iOS app settings</Link>
                                        <Link className={classNames('item tu3',activeMenu==='tu03' ? 'current' : '')} onClick={()=>this.setState({activeMenu: 'tu03'})}>Android app settings</Link>
                                    </div>
                                    <div className="tuto-qrcode">
                                        ...
                                        <div className="qrcode-desc">
                                            <p>Scan the QR code<br/>and <em>download<br/>the new mySUNI!</em></p>
                                        </div>
                                    </div>
                                </div>
                                <div className="cont-body">
                                    ...
                                    { activeMenu === 'tu02' && (
                                        <div className='tab_cont tu2'>
                                            <div className='tab_title'>
                                                <img src="https://image.mysuni.sk.com/suni-asset/public/images/all/tuto-v5/tuto-v5-tab2-title-en.png" alt="IOS 써니 앱 설정" />
                                            </div>
                                            <Swiper {...paramsIOS}>
                                    ...
                                    { activeMenu === 'tu03' && (
                                        <div className='tab_cont tu3'>
                                            <div className='tab_title'>
                                                <img src="https://image.mysuni.sk.com/suni-asset/public/images/all/tuto-v5/tuto-v5-tab3-title-en.png" alt="Android 써니 앱 설정" />
                                            </div>
                                            <div className="tab-img-wrap">
                                                <div className="tab-img t-img1"></div>
                                            </div>
