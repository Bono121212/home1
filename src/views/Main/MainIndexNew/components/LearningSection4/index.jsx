...
import LearningLoopType1D from '../LearningLoopType1D';


class LearningSection4 extends Component {
    render() {
        return (
            <>
                <Segment className="full learning-section type1">
                    ...
                    <div className="section-body">
                        ...
                        <LearningLoopType1D swipeName="swiperRequired"/>
                    </div>
                </Segment>
            </>
        )
...
export default LearningSection4