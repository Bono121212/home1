						...
						<div className="main_left">
							...
							<div className="personal-info-go">
								...
								<div className="info-boading">
									<Link to="/etc/promotion-dashboard" className="boading-wrap">
										<span className="banner part2"></span>
										<span className="banner part1"></span>
										<span className="blind">Growth Level up Challenge 참여 현황 확인하기</span>
									</Link>
								</div>
							</div>
						</div>
