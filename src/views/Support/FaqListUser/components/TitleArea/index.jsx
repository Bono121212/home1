                ...
                <div className="support-info">
                    ...
                    <div className="tip-area">
                        ...
                        <div className="q-list">
                            <Link to="#" target="_blank"><span className="ellipsis">동영상 재생이 잘 되지 않습니다. 어떡해야 하나요? Text영역 510px 이상일 경우말줄임표시</span></Link>
                            <Link to="#" target="_blank"><span className="ellipsis">결제 환불 방법을 알려주세요.</span></Link>
                            <Link to="#" target="_blank"><span className="ellipsis">동영상 재생이 잘 되지 않습니다. 어떡해야 하나요? Text영역 510px 이상일 경우말줄임표시</span></Link>
                        </div>
                    </div>
                </div>
