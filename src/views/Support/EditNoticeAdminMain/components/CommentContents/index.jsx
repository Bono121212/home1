        ...
        return (
            <div className="comment-area">
                ...
                <Comment.Group className='base'>
                    ...
                    {/* .comment : 2줄이상 노출, 대댓글 */}
                    <Comment>
                        <Comment.Avatar src='/images/all/img-profile-56-px.svg'/>
                        <Comment.Content>
                            <Comment.Author as='a'>김연아</Comment.Author>
                            <Comment.Metadata>
                                <span className="date">2019.10.23</span>
                    ...
                    <Comment>
                        ...
                        <Comment.Group>
                            <Comment>
                                <span className="avatar"><Icon className='avatar56'/><span
                                    className='blind'>avatar</span></span>
                                <Comment.Content>
                                    <span className="empty h56">삭제된 댓글입니다.</span>
                                </Comment.Content>
                            </Comment>
                        ...
                        <Comment.Content>
                            ...
                            <Form reply className='base'>
                                <div className="outline">
                                    <Form.TextArea placeholder="Writing...">대댓글 입력</Form.TextArea>
                                    <div className="more">
                                        <div className="count"><span className="now">0</span>/<span
                                            className="max">500</span></div>
                                        <Button icon className='img-icon photo'><Icon className='photo50'/><span
                        ...
                        <Comment.Group>
                            <Comment>
                                ...
                                <Comment.Content>
                                    ...
                                    <Form reply className='base'>
                                        <div className="outline">
                                            <Form.TextArea placeholder="Writing...">@강하늘 대댓글 수정</Form.TextArea>
                                            {/* tag-menu */}
