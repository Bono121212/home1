                                    ...
                                    <div className="cell v-middle">
                                        <div className="ui h40 calendar" id="rangestart">
                                            <div className="ui input right icon">
                                                ...
                                                <input type="text" defaultValue='2019-11-11'/>
                                            </div>
                                        </div>
                                        ...
                                        <div className="f-list">
                                            <div className="scrolling">
                                                <div className="college">
                                                    ...
                                                    <Button className='toggle toggle3 active' aria-pressed="false">
                                                        AI (4)
                                                    </Button>
                                                        ...
                                                        <li>
                                                            <Checkbox
                                                                label={<label>2줄일 경우 2줄일 경우 2줄일 경우 2줄일 경우 2줄일 경우 2줄일
                                                                    경우<span>(30)</span></label>} className='base' defaultChecked/>
                                                        </li>
                                                        <li>
