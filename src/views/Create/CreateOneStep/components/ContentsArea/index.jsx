...
import {
    Segment, Form, Icon, Radio, Select, Image, Button, TextArea, Grid
                ...
                <div className="apl-form-wrap create">
                    <Form>
                        ...
                        <Form.Field>
                            ...
                            {publicScope &&
                                <div className='select-box'>
                                    <Select placeholder='College 선택' className='dropdown selection w302'/>
                        ...
                        <Form.Field>
                            ...
                            <div className="ui right-top-count input">
                                ...
                                <TextArea placeholder='등록하는 강좌에 대한 교육목표를 입력해주세요. (최대 500자 입력 가능)'/>
                            </div>
                        </Form.Field>
                        ...
                        <Form.Field>
                            ...
                            <div className="ui right-top-count input">
                                <span className="count"><span className="now">0</span>/<span className="max">500</span></span>
                                <TextArea placeholder='등록하는 강좌에 대한 교육대상을 입력해주세요. (최대 500자 입력 가능)'/>
                            </div>
                        </Form.Field>
                        ...
                        <Form.Field>
                            ...
                            <div className="round-wrap2">
                                <div className="top text">
                                    <ul>
                                        <li>
                                            <span className="empty">파일을 업로드해주세요.</span>
                                        </li>
                                    </ul>
                                </div>
