...
import {
    Segment, Form, Select, Image, Table
                ...
                <div className="apl-form-wrap create">
                    <Form>
                        ...
                        <Form.Field>
                            ...
                            <div className="ui form">
                                <div className="ui right-top-count input">
                                    ...
                                    <textarea
                                        placeholder="교육 목표를 입력해주세요. (최대 500자 입력 가능)">모든 구성원들의 한단계 발전을 위해</textarea>
                        ...
                        <Form.Field>
                            ...
                            <div className="ui grid create">
                                <div className="column">
                                    <Select placeholder='선택해주세요' className='dropdown w100'
                                            options={selectOptions02} defaultValue={selectOptions02[1].value}/>
                                </div>
                                <div className="column">
                                    <ClearInputBox01/>
                                </div>
                        ...
                        <Form.Field>
                            <div className="ui grid create create2">
                                ...
                                <div className="column">
                                    <div className="text2"><a href={()=>false}>Education UX/UI class_1.avi</a></div>
                                </div>
                            </div>
                        </Form.Field>
                        <Form.Field>
                            ...
                            <div className="ui grid create create2">
                                ...
                                <div className="column">
                                    <div className="field">
                                        ...
                                        <div className="ui base radio checkbox">
                                            <input type="radio" name="base" checked="checked" tabIndex="0"
                                                   className="hidden"/>
                                                <label>비공개</label>
                                        </div>
                                    </div>
