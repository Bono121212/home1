                            ...
                            <ul>
                                ...
                                <li>
                                    ...
                                    <ul>
                                        <li>
                                            <a href={()=>false}>
                                                <span className="underline">관심 채널</span>
                                            </a>
                                        </li>
                                    </ul>
                                </li>
                            ...
                            <ul>
                                ...
                                {/* <li>
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href={()=>false}>
                                                <span className="underline">Job&Role</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href={()=>false}>
                                                <span className="underline">LMI</span>
                                            </a>
                                        </li>
                                    </ul>
                                </li> */}
                            ...
                            <ul>
                                <li>
                                    ...
                                    <ul>
                                        <li>
                                            <a href={()=>false}>
                                                <span className="underline">나의 학습 현황</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href={()=>false}>
                                        ...
                                        <li>
                                            <a href={()=>false}>
                                                <span className="underline">프로필 설정</span>
                                            </a>
                                        </li>
                                    </ul>
                                </li>
