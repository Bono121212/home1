        ...
        return (
            <Card className={`card-h ${activeClass}`} onMouseEnter={() => this.handleHover(true)}
                ...
                <div className="card-inner">
                    ...
                    <div className="title-area">
                        ...
                        <div className="header">
                            Mobile App UI/UX GUI Design Tutorials (모바일 앱 UX UI GUI)
                        </div>
                    </div>
                    ...
                    <div className="foot-area">
                        <div className="fixed-rating">
                            <Rating defaultRating={3} maxRating={5} size='small' disabled
                ...
                <div className="hover-content">
                    <div className="title-area">
                        <Label color='purple'>AI</Label>
                        <div className="header">Mobile App UI/UX GUI Design Tutorials (모바일 앱 UX
                            UI GUI)
                        </div>
                    </div>
