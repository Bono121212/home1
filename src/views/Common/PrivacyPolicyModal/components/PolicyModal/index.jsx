                            ...
                            <div className="scrolling-80vh">
                                ...
                                <div className="bt">
                                    <table className="four">
                                        ...
                                        <tbody>
                                        <tr>
                                            <td>SK 그룹 계열회사 (자세한 내역은 <a href="http://sk.co.kr" target="_blank" rel="noopener noreferrer">http://sk.co.kr</a> 에서 확인 가능)
                                            </td>
                                ...
                                <div className="text3">회사는 위탁계약 체결시 정보통신망법 제25조, 개인정보보호법 제26조에 따라 위탁업무 수행목적 외 개인정보 처리금지,
                                    ...
                                    안전하게 처리하는지를 감독하고 있습니다.<br/>위탁업무의 내용이나 수탁자가 변경될 경우에는 지체없이 본 개인정보 처리방침을 통하여 공개하도록
                                    하겠습니다.
                                </div>
                                ...
                                <div className="text3">② 제1항에 따른 권리 행사는 개인정보 보호법 시행규칙 별지 제8호 서식 또는 각 구성원 소속사
                                    사규(개인정보보호규칙)에 따라 서면 &middot; 전자우편 &middot; 모사전송(FAX) 등을 통하여 하실 수 있습니다. 다만, 구성원 개인정보의
                                    오류로 인하여 불이익이 발생할 수 있으니 상세한 사항은 인사부서에 문의하여 주시기 바랍니다.
                                </div>
                                ...
                                <div className="text3">② 동의 철회는 홈페이지나 고객센터에 연락하여 본인 확인 절차를 거치신 후 직접 동의철회 신청을 하시거나,개인정보
                                    보호책임자 또는 개인정보보호담당자에게 서면 또는 E-Mail등으로 송부하여 주시면 지체 없이 조치하여 드립니다.
                                </div>
                                ...
                                <div className="text3">② 처리정지 요청은 홈페이지나 고객센터에 연락하여 본인 확인 절차를 거치신 후 직접 처리정지를 신청을 하시거나,
                                    개인정보 보호책임자 또는 개인정보 보호담당자에게 서면 또는 E-Mail등으로 송부하여 주시면 지체 없이 조치하여 드립니다. 다만, 다음 각 호의 어느
                                    하나에 해당하는 경우에는 SK 구성원의 처리정지 요구를 거절할 수 있습니다.
                                </div>
                                ...
                                <div className="text3">※ 로그인이 불가능하신 고객께서는 ‘개인정보 처리 요구서 다운로드 하기’를 이용하여 신청서를 작성하신 후 개인정보
                                    담당자에게 이메일 송부 하여 주시기 바랍니다. (문의 <a
                                        href="mailto:test@test.com">test@test.com</a>) <br/>
                                        <a href="https://mysuni.sk.com/api/depot/depotFile/flow/download/ee-1">개인정보처리
                                        요구서 다운로드 하기</a></div>
                                ...
                                <div className="text5">정보주체로부터 동의 받은 개인정보 보유기간이 경과하거나 처리 목적이 달성되었음에도 불구하고 다른 법령에 따라
                                    개인정보를 계속 보존하여야 하는 경우에는 해당 개인정보는 별도의 데이터베이스(DB)로 옮기거나 보관장소를 달리하여 보관합니다.<br/>또한, 처리목적의
                                    달성, 해당 서비스의 폐지, 사업의 종료 등 개인정보가 불필요한 것으로 인정되는 날로부터 3일 이내에 파기합니다.
                                </div>
                                ...
                                <div className="text5">mySUNI는 수집한 개인정보의 이용목적이 달성되거나, 서비스 회원을 탈퇴할 경우 당해 SK 구성원의 개인정보를 다음
                                    각호의 방법으로 지체 없이 파기하여 향후 어떠한 용도로도 열람 또는 이용할 수 없도록 처리하고 있습니다. 단, '5.개인정보 보유기간 및 이용기간
                                    ②'와 같은 예외 경우를 두고 있습니다.
                                </div>
                                ...
                                <div className="text4">- 임직원이 SK 구성원의 개인정보를 처리하기 이전에 보안서약서를 통하여 SK 구성원의 개인정보에 대한 정보유출을
                                    사전에 방지하고 사내규정에 대한 이행사항 및 준수여부를 감시하기 위한 내부절차를 마련하고 있습니다.
                                </div>
                                ...
                                <div className="text4">- 그 외 내부 관리자의 실수나 기술관리 상의 사고로 인해 개인정보의 상실, 유출, 변조, 훼손이 유발될 경우 즉각
                                    SK 구성원께 사실을 알리고 적절한 대책과 보상을 강구할 것입니다.
                                </div>
                                <div className="text3">③ 하지만 근본적으로 개인정보의 보안관리에는 회원 본인의 노력도 중요합니다. Online 서비스는 오직 아이디와
                                    ...
                                    알 수 있는 내용으로 패스워드를 구성해야 하며, 생년월일 또는 전화번호 등 타인이 쉽게 도용 할 수 있는 패스워드의 사용을 지양해야 합니다. 또한
                                    공동으로 사용하는 PC에서 저희 Online서비스에 접속하여 로그온 한 상태에서 다른 사이트로 이동할 경우, 혹은 서비스 이용을 종료하였을 경우에는
                                    반드시 해당 브라우저를 종료하시기 바랍니다. 그렇지 않을 경우, 해당 브라우저를 통해 아이디, 패스워드, 주민등록번호가 포함된 SK 구성원의 정보가
                                    타인에게 손쉽게 유출될 위험이 있습니다
                                </div>
                                ...
                                <div className="text3">① SK 구성원께서는 mySUNI의 서비스를 이용하시며 발생하는 모든 개인정보보호 관련 민원에 대해개인정보보호책임자
                                    및 개인정보보호담당자에게 알려주시기 바랍니다. 지적하신 문제를 조속히 확인하고 수정이 필요한 경우에는 최대한 빠른 시간 내에 조치하도록 노력하겠습니다.
                                </div>
                                <div className="text3">② 또한 개인정보 침해에 대한 신고, 상담이 필요하신 경우에는 한국인터넷진흥원(KISA) 개인정보 침해신고센터로
                                    문의하시기 바랍니다. SK 구성원이 개인정보침해를 통한 금전적, 정신적 피해를 입으신 경우에는 개인정보분쟁조정위원회에 피해구제를 신청하실 수 있습니다.
                                </div>
                                ...
                                <div className="text3">▶ 대검찰청 사이버수사과 : (국번없이)1301, <a
                                    href="mailto:test@test.com">test@test.com</a> , <a href="http://www.spo.go.kr" target="_blank" rel="noopener noreferrer">spo.go.kr</a>
                                </div>
                                <div className="text3">▶ 경찰청 사이버안전국 : (국번없이)182, <a
                                    href="mailto:cyberbureau.police.go.kr">cyberbureau.police.go.kr</a></div>
