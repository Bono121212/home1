                    ...
                    <div className="college-cont-title ai">
                        <div className="belt">
                            <div className="panopto">
                                <iframe
                                    title='video type'
                                    src='https://sku.ap.panopto.com/Panopto/Pages/BrowserNotSupported.aspx?continue=true&ReturnUrl=%2FPanopto%2FPages%2FEmbed.aspx%3Fid%3D7f027217-af12-4ce2-8216-ab42002e5be2&offerviewer=false&showtitle=false&interactivity=none&showbrand=false
'
                                    width="436"
                                    height="245"
                            ...
                            <div className="normal">AI Category는 SK 구성원 누구나 알아야 할 기본 지식을 바탕으로,<br/>
                    ...
                    <div className="college-cont-title dt">
                        <div className="belt">
                            <div className="panopto">
                                <iframe
                                    title='audio type'
                                    src='https://sku.ap.panopto.com/Panopto/Pages/BrowserNotSupported.aspx?continue=true&ReturnUrl=%2FPanopto%2FPages%2FEmbed.aspx%3Fid%3D47d87f43-03b6-4559-97eb-ab420078ff59
'
                                    width="436"
                                    height="245"
                                    style={{padding: '0px', border: '0px'}}
            ...
            <Tab.Pane>
                <div className="ui attached tab full segment active" data-tab="colleges3">
                    <div className="college-cont-title happiness">
                        <div className="belt">
                            <div className="label">행복 Category</div>
                        ...
                        <div className="belt">
                            ...
                            <div className="normal">2020년 1월 행복학개론, SK의 행복경영, 마음 근력 키우기, 긍정 습관 만들기 등 총 4개 과정이
                                ...
                                4개의 과정에 추가하여 <strong>2020년 말</strong>까지 행복 실천을 위한 <strong>나머지 공통 과정, SK 행복 리더십 과정, 전문가
                                    과정</strong>을<br/>순차적으로 개설할 예정입니다.
                            </div>
                        </div>
                    </div>
                            ...
                            <ol className="list">
                                <li>
                                    <div className="label chip1"><i className="numb-1 icon"><span
                                        className="blind">1</span></i>Deep Change & Design
                                    </div>
                                ...
                                <li>
                                    <div className="label chip2"><i className="numb-2 icon"><span
                                        className="blind">2</span></i>고객중심의 디자인 방법론
                                    </div>
                                ...
                                <li>
                                    <div className="label chip3"><i className="numb-3 icon"><span
                                        className="blind">3</span></i>일하는 방식의 혁신
                                    </div>
                                ...
                                <li>
                                    <div className="label chip4"><i className="numb-4 icon"><span
                                        className="blind">4</span></i>그룹 전략 Biz. 디자인
                                    </div>
...
'
                ...
                <div className="ui attached tab full segment active" data-tab="colleges7">
                    ...
                    <div className="college-cont-map">
                        <div className="belt">
                            <div className="label">전체 커리큘럼</div>
                            <div className="map">
                                <Image src='/images/all/img-co7.svg' alt=''/>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="ui attached tab full segment active" data-tab="colleges8">
                    <div className="college-cont-title management">
                        <div className="belt">
                            ...
                            <div className="normal">Management. College는 전략/재무/마케팅/HR 등 공통 직무 Domain別 전문역량과 Deep Change를 위한
                                실행역량 향상을 위한 학습
                                Program을 제공합니다.
                            </div>
                            <ul className="tag-wrap">
                ...
                <div className="ui attached tab full segment active" data-tab="colleges9">
                    ...
                    <div className="college-cont-map in">
                        <div className="belt">
                            <div className="label">전체 커리큘럼</div>
                            <div className="map">
                                <Image src='/images/all/img-co9.png' alt="" />
                            </div>
                        </div>
                    </div>
            ...
            <Tab.Pane>
                <div className="ui attached tab full segment active" data-tab="colleges11">
                    ...
                    <div className="college-cont-map energy">
                        <div className="belt">
                            <div className="map">
                                <Image src="/images/all/in-02-01-c-11.svg" alt="" />
                            </div>
                        </div>
                    </div>
                </div>
    ...
    },
    {
        menuItem: 'SK아카데미', render: () =>
            <Tab.Pane>
                <div className="ui attached tab full segment active" data-tab="colleges10">
                    <div className="college-cont-title skacademy">
                        <div className="belt">
                            <div className="img">
                                <Image src='/images/all/player-area.svg' alt="" />
                            </div>
                    ...
                    <div className="college-cont-map skacademy">
                        <div className="belt">
                            <div className="label">전체 커리큘럼</div>
                            <div className="map">
                                <Image src='/images/all/img-co10.svg' alt="" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="college-tag skacademy">
                        <div className="belt">
                            ...
                            <div className="strong">SK Leadership Pipeline 및 Assessment와 연계한 체계적인 미래경영자 육성</div>
                            <ul className="tag-wrap">
                                <li># HLP</li>
                                <li># 여성리더</li>
                            </ul>
                            <div className="label chip7">역량 School</div>
                            <div className="strong">mySUNI의 Management Category와 연계, 그룹 공통 직무 및 Biz. 전문역량 강화</div>
                            <ul className="tag-wrap">
