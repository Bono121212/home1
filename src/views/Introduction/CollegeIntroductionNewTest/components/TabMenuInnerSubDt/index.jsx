...
import Dtsub01 from "../../../../../images/all/dt-con01-1.png";
          ...
          <div className="belt">
              ...
              <div className="ai_box">
                ...
                <ul>
                  <li className="ai_sub_li">
                    <a href={()=>false}>MWC 2021 (6/28~7/1) ※Upload 예정</a>
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="ai_sub_table dt">
              ...
              <div className="ai_box">
                ...
                <ul>
                  <li className="ai_sub_li">
                    <a href={()=>false}>[이천포럼 2021] ※Upload 예정</a>
                  </li>
                  <li>
...
export default TabMenuInnerSubDt;
