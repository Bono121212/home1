...
import Chart from "../../../../../images/all/icon-chart.png";
...
import Ing31 from "../../../../../images/all/ing-31.png";
import Ing30 from "../../../../../images/all/ing_30.png";
    ...
    render: () => (
      <Tab.Pane attached={false}>
        ...
        <div className="belt college-mana-text">
            ...
            <p className="p_link">각 Badge를 클릭하면 해당 페이지로 이동합니다.</p>
        </div>
        ...
        <div className="college-cont-map sub wrap01">
            <div className="belt">
                ...
                {/* <div className="management-map">
                    <strong className="label">Management College 체계도</strong>
                    <div className="management">
                        <div className="title-box">
                            <em className="dark">Intergrative(통합)</em>
                            <strong>3. 경영 Perspective 확보 위한 철학, 통합 의사결정</strong>
                            <span>신규 확장 영역</span>
                        </div>
                        <div className="content-box">
                            <div className="dark">
                                <List as="ul">
                                    <List.Item as="li" className="list-item"><Link to="">Advanced Management Program</Link></List.Item>
                                    <List.Item as="li" className="list-item"><Link to="">Capstone Project</Link></List.Item>
                                    <List.Item as="li" className="list-item"><Link to="">경영 Simulation, Case Study</Link></List.Item>
                                </List>
                            </div>
                        </div>
                    </div>
                    <div className="management">
                        <div className="title-box">
                            <em className="medi">Combined(융합)</em>
                            <strong>2. 복수의 Function Group/ Competency 역량간 융합</strong>
                            <span>신규 확장 영역</span>
                        </div>
                        <div className="content-box">
                            <div className="medi">
                                <List as="ul">
                                    <List.Item as="li" className="list-item">
                                        <div className="width3 dashed-long"><Link to="">Biz. Analytics와 의사결정</Link></div>
                                        <div className="width1 D3F0EE margin3"><Link to="">Biz. Analytics와 의사결정</Link></div>
                                    </List.Item>
                                    <List.Item as="li" className="list-item">
                                        <div className="width1 dashed"><Link to="">통합 SCM 전략</Link></div>
                                        <div className="width1 D3F0EE margin2 dashed"><Link to="">통합 SCM 전략</Link></div>
                                        <div className="width1 D3F0EE margin2"><Link to="">통합 SCM 전략</Link></div>
                                    </List.Item>
                                    <List.Item as="li" className="list-item">
                                        <div className="width2 margin1"><Link to="">Marketing 성과 분석(ROI 등)</Link></div>

                                    </List.Item>
                                    <List.Item as="li" className="list-item">
                                        <div className="width1 dashed"><Link to="">비시장 전략</Link></div>
                                        <div className="width1 D3F0EE margin2"><Link to="">비시장 전략</Link></div>
                                        <div className="width2 margin3"><Link to="/">법무 협상 실무 과정</Link></div>
                                    </List.Item>
                                    <List.Item as="li" className="list-item">
                                        <div className="width2"><Link to="">Risk Management</Link></div>
                                        <div className="width1 margin3 dashed"><Link to="">구매협상과정</Link></div>
                                        <div className="width1 margin2"><Link to="">구매협상과정</Link></div>
                                    </List.Item>
                                    <List.Item as="li" className="list-item">
                                        <div className="width2"><Link to="">Biz Strategy & Finacial Performance</Link></div>
                                        <div className="width1 margin2"><Link to="">행복과 조직설계</Link></div>
                                    </List.Item>
                                </List>
                            </div>
                        </div>
                    ...
                    <div className="management">
                        <div className="title-box">
                            <em className="light">Function  &  Competency</em>
                            <strong>1. Function별 지식/전문성, 공통 역량 확보</strong>
                            <span>기존 집중 영역</span>
                        </div>
                        <div className="content-box">
                            <div className="light">
                                <div className="function">
                                    <List as="ul">
                                        <List.Item as="li" className="list-item"><Link to="">전사 Intelligence</Link></List.Item>
                                        <List.Item as="li" className="list-item"><Link to="">자금 조달/운영</Link></List.Item>
                                        <List.Item as="li" className="list-item"><Link to="">마케팅 조사 방법론</Link></List.Item>
                                        <List.Item as="li" className="list-item"><Link to="">전략적 HR</Link></List.Item>
                                        <List.Item as="li" className="list-item"><Link to="">전략적 BP 발굴</Link></List.Item>
                                        <List.Item as="li" className="list-item"><Link to="">기업법</Link></List.Item>

                                        <List.Item as="li" className="list-item"><Link to="">전략실행과 성과관리</Link></List.Item>
                                        <List.Item as="li" className="list-item"><Link to="">국제 세무</Link></List.Item>
                                        <List.Item as="li" className="list-item"><Link to="">B2B 마케팅 & Sales</Link></List.Item>
                                        <List.Item as="li" className="list-item"><Link to="">Agile 직무 관리</Link></List.Item>
                                        <List.Item as="li" className="list-item"><Link to="">구매전략</Link></List.Item>
                                        <List.Item as="li" className="list-item"><Link to="">공정거래법</Link></List.Item>

                                        <List.Item as="li" className="list-item"><Link to="">Corporate Strategy</Link></List.Item>
                                        <List.Item as="li" className="list-item"><Link to="">고급 회계</Link></List.Item>
                                        <List.Item as="li" className="list-item"><Link to="">디지털 융합 마케팅</Link></List.Item>
                                        <List.Item as="li" className="list-item"><Link to="">조직 설계 방법론</Link></List.Item>
                                        <List.Item as="li" className="list-item"><Link to="">구매의 미래, 품질관리</Link></List.Item>
                                        <List.Item as="li" className="list-item"><Link to="">특허활용과 매입</Link></List.Item>
                                    </List>

                                    <List as="ul">
                                        <List.Item as="li" className="list-item"><Link to="">전략101</Link></List.Item>
                                        <List.Item as="li" className="list-item"><Link to="">세무회계 실무 첫 걸음</Link></List.Item>
                                        <List.Item as="li" className="list-item"><Link to="">마케팅 Framework</Link></List.Item>
                                        <List.Item as="li" className="list-item"><Link to="">HR 공통</Link></List.Item>
                                        <List.Item as="li" className="list-item"><Link to="">구매 Process</Link></List.Item>
                                        <List.Item as="li" className="list-item"><Link to="">법무 101</Link></List.Item>

                                        <List.Item as="li" className="list-item"><Link to="">경영환경분석</Link></List.Item>
                                        <List.Item as="li" className="list-item"><Link to="">궁금해요, 내부회계 관리제도</Link></List.Item>
                                        <List.Item as="li" className="list-item"><Link to="">B2B 101</Link></List.Item>
                                        <List.Item as="li" className="list-item"><Link to="">인력 확보</Link></List.Item>
                                        <List.Item as="li" className="list-item"><Link to="">입찰 전략 수립</Link></List.Item>
                                        <List.Item as="li" className="list-item"><Link to="">지식재산권 101</Link></List.Item>

                                        <List.Item as="li" className="list-item"><Link to="">전략적문제해결</Link></List.Item>
                                        <List.Item as="li" className="list-item"><Link to="">처음만나는 원가/관리회계</Link></List.Item>
                                        <List.Item as="li" className="list-item"><Link to="">상품기획101</Link></List.Item>
                                        <List.Item as="li" className="list-item"><Link to="">직무 관리</Link></List.Item>
                                        <List.Item as="li" className="list-item"><Link to="">구매 Do & Don’t</Link></List.Item>
                                        <List.Item as="li" className="list-item"><Link to="">특허분쟁개론</Link></List.Item>

                                        <List.Item as="li" className="list-item"><Link to="">전략적숫자읽기</Link></List.Item>
                                        <List.Item as="li" className="list-item"><Link to="">Fun-Fun한 회계</Link></List.Item>
                                        <List.Item as="li" className="list-item"><Link to="">브랜드 관리</Link></List.Item>
                                        <List.Item as="li" className="list-item"><Link to="">보상</Link></List.Item>
                                        <List.Item as="li" className="list-item"><Link to="">SCM</Link></List.Item>
                                        <List.Item as="li" className="list-item"><Link to="">보상</Link></List.Item>
                                    </List>
                                </div>
                                <div className="competency">
                                    <List as="ul">
                                        <List.Item as="li" className="list-item"><Link to="">Decision Making</Link></List.Item>
                                        <List.Item as="li" className="list-item"><Link to="">Negotiation</Link></List.Item>
                                        <List.Item as="li" className="list-item"><Link to="">Measurement</Link></List.Item>
                                        <List.Item as="li" className="list-item"><Link to="">Problem Solving</Link></List.Item>
                                        <List.Item as="li" className="list-item"><Link to="">Comm. Skill</Link></List.Item>
                                    </List>
                                </div>
                            </div>
                            <div className="management-bottom">
                                <List as="ul">
                                    <List.Item as="li" className="list-item"><Link to="">기업 경영/전략</Link></List.Item>
                                    <List.Item as="li" className="list-item"><Link to="">재무/회계</Link></List.Item>
                                    <List.Item as="li" className="list-item"><Link to="">마케팅/Brand</Link></List.Item>
                                    <List.Item as="li" className="list-item"><Link to="">HR/조직 설계</Link></List.Item>
                                    <List.Item as="li" className="list-item"><Link to="">SCM/Operation</Link></List.Item>
                                    <List.Item as="li" className="list-item"><Link to="">법무/IP</Link></List.Item>
                                </List>
                            </div>
                        </div>
                    </div>
    ...
    render: () => (
      <Tab.Pane attached={false}>
        ...
        <div className="college-link-box">
          <div className="belt">
            <img src={Category} className="manage_cate" alt="" />
            ...
            <div className="legal-wrap flex sub">
              <div className="fundamental-topic width50">
                <div className="con_wrap sub01">
                  ...
                  <div className="con_box">
                    <div className="con_sub_box">
                      <a href="https://mysuni.sk.com/suni-main/lecture/cineroom/ne1-m2-c2/college/CLG00004/course-plan/COURSE-PLAN-f6/Course/C-LECTURE-cd">
                        <ul>
                          <li>SV 측정의 이해</li>
                    ...
                    <div className="con_sub_box">
                      <a href="https://mysuni.sk.com/suni-main/lecture/cineroom/ne1-m2-c2/college/CLG00008/course-plan/COURSE-PLAN-v8/Course/C-LECTURE-r5">
                        <ul>
                ...
                <div className="con_wrap sub02">
                  ...
                  <div className="con_box">
                    <div className="con_sub_box">
                      <ul className="ul_style">
                        <li>
                          <a href="https://mysuni.sk.com/suni-main/lecture/cineroom/ne1-m2-c2/college/CLG00008/course-plan/COURSE-PLAN-4a/Course/C-LECTURE-2h">
                            엑셀 실무 Master 1 ~ 8
                          </a>
                        </li>
                        <li>
                          <a href="https://mysuni.sk.com/suni-main/lecture/cineroom/ne1-m2-c2/college/CLG00008/course-plan/COURSE-PLAN-4x/Course/C-LECTURE-2a">
                            검색해도 찾기 힘든 꼭 필요한 엑셀 함수
                          </a>
                        </li>
                        <li>
                          <a href="https://mysuni.sk.com/suni-main/lecture/cineroom/ne1-m2-c2/college/CLG00008/course-plan/COURSE-PLAN-3n/Course/C-LECTURE-2l">
                            부장님은 내 기획서가 쓰레기라고 말했지
                          </a>
                        </li>
                        <li>
                          <a href="https://mysuni.sk.com/suni-main/lecture/cineroom/ne1-m2-c2/college/CLG00008/course-plan/COURSE-PLAN-3u/Course/C-LECTURE-2j">
                            한국인이 많이 하는 이메일 영어실수 上 下
                          </a>
                        </li>
                        <li>
                          <a href="https://mysuni.sk.com/suni-main/lecture/cineroom/ne1-m2-c2/college/CLG00008/course-plan/COURSE-PLAN-50/Course/C-LECTURE-28">
                ...
                <div className="con_wrap sub02">
                  ...
                  <div className="con_box">
                    <div className="con_sub_box">
                      <ul className="ul_style">
                        <li>
                          <a href="https://mysuni.sk.com/suni-main/lecture/cineroom/ne1-m2-c2/college/CLG00008/course-plan/COURSE-PLAN-3o/Course/C-LECTURE-2k">
