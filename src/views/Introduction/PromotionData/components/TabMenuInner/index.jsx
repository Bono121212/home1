                ...
                <div className="ui attached tab full segment active" data-tab="colleges1">
                    ...
                    <div className="college-tag">
                        <div className="belt">
                            ...
                            <div className="strong">개발자에서 전문 AI개발자로의 도약을 위한 컨텐츠</div>
                            <ul className="tag-wrap">
                ...
                <div className="ui attached tab full segment active" data-tab="colleges2">
                    <div className="college-cont-title dt">
                        <div className="belt">
                            ...
                            <div className="normal">Digital Skill을 장착하고 고객과 업을 이해하여,<br/>SK Deep Change를 맨 앞에서 이끌어 나가실
                                구성원들을 위한
                                과정들이,<br/>여기 DT Category에 마련되어 있습니다.
                            </div>
                        </div>
                    </div>
                    <div className="college-tag">
        ...
        menuItem: '혁신디자인', render: () =>
            <Tab.Pane>
                <div className="ui attached tab full segment active" data-tab="colleges5">
                    ...
                    <div className="college-free2">
                        <div className="belt">
                            <div className="label">4개 학습영역</div>
                            <ol className="list">
                                <li>
                                    <div className="label"><i className="numb-1 icon"><span
                                        className="blind">1</span></i>Deep Change &
                                        Design
                                    </div>
                                ...
                                <li>
                                    <div className="label"><i className="numb-2 icon"><span
                                ...
                                <li>
                                    <div className="label"><i className="numb-3 icon"><span
                                ...
                                <li>
                                    <div className="label"><i className="numb-4 icon"><span
