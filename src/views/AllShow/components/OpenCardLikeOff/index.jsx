...
import cardThumb1 from "../../../../../images/all/thumbnail-sample-02.png";

class OpenCardLikeOff extends Component {
    render() {
        return (
                ...
                <div className="card_inner">
                    <div className="card_header">
                        ...
                        <div className="iconbox">
                            {/* 
                                가입대기 보이기 : waiton 클래스
                                가입대기 숨기기 : waitoff 클래스

                                비공개 커뮤니티 보이기 : lockon 클래스
                                비공개 커뮤니티 숨기기 : lockoff 클래스
                    ...
                    <Link to="/" className="card_body">
                        <strong className="card_title">데이터 혁신이 답이다 </strong>
                        <div className="card_contents">
                            <span className="card_thumb"><Image src={cardThumb1} alt="커뮤니티썸네일"/></span>
...
export default OpenCardLikeOff;